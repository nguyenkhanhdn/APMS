...
namespace APMS.Controllers
{
    public class VehicleTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VehicleTypeId,TypeName,PricePerHour")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VehicleTypeId,TypeName,PricePerHour")] VehicleType vehicleType)
        {
