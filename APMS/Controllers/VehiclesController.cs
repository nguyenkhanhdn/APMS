...
namespace APMS.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        {
            var parkingDbContext = _context.Vehicles.Include(v => v.User).Include(v => v.VehicleType);
        ...
        public async Task<IActionResult> Create([Bind("VehicleId,LicensePlate,UserId,VehicleTypeId")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VehicleId,LicensePlate,UserId,VehicleTypeId")] Vehicle vehicle)
        {
