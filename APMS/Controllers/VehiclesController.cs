...
namespace APMS.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        {
            var parkingDbContext = _context.Vehicles.Include(v => v.VehicleType);
        ...
        public async Task<IActionResult> Create([Bind("VehicleId,LicensePlate,OwnerName,VehicleTypeId")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VehicleId,LicensePlate,OwnerName,VehicleTypeId")] Vehicle vehicle)
        {
